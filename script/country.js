...
var sel = [];
var col = ["#d21819", "#8265b9", "#ed9740", "#d1ed40", "#7bed40", "#40ed5d", "#40eeb3", "#40cfed", "#0e47a1", "#1976d3", "#673bb7", "#8e24aa", "#d81a60", "#ec407a", "#d32f2e", "#f6410a", "#fe5722", "#fb8c00", "#fec107", "#f3ce37", "#525252"];
...
visualMapAct = function(lis, data, col1) {
  $('.visualMap').append(lis);

  var t = $(".visualMap").css("height");
  $(".visualMap").css("margin-top", parseInt(t) / 2 * -1);

  var boxIndex = [];
  for (j = data.length; j > 0; j--) boxIndex.push(j);
  for (i = 0; i < data.length; i++) {
    var r = ".visualMap li:nth-child(" + boxIndex[i] + ") span";
    $(r).css("background", col1[i])
  }
}
